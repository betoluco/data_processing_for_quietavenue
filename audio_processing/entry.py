...
source_folder = '2141-Mills-Ave-Menlo-Park-CA-94025/audio/'
...
destination_folder = '2141-Mills-Ave-Menlo-Park-CA-94025/'
...
dynamodb_item_key =	'2141-Mills-Ave-Menlo-Park-CA-94025'
recording_start_datetime = datetime(2022, 3, 6, 19, 34) #YYYY, MM, DD, HH, MM,

new_helper = helpers(source_folder, destination_folder, dynamodb_item_key)
#fetchAndPreprocess(new_helper)
extractData(recording_start_datetime, new_helper)
